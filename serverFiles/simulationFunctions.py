...
simulationFiles = dict()
runningSimulations = dict()
completedSimulations = dict()
activeClients = dict()


# TODO: Create objects to store session data instead
class SimData:
    """
    Class for information regarding a simulation [unfinished]
    """
...
def generateToolboxConfig(
    simulationID: str, fileID: Optional[str], joint: Optional[str]
) -> str:
    """
    ...
    simulationFiles[simulationID].add(toolboxConfigPath)
    print(
        (
...
async def runSimulation(
    ...
    simulationFiles[simulationID] |= simFiles | {guidePath}
...
def epidemic(
    ...
    simulationFiles[simulationID] |= {oldFilename, newFilename}
